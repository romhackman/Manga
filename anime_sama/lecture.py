...
# ======================================================
# Dossier du launcher (où sera stocké le config.json)
# ======================================================
LAUNCHER_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Luncher"))
...
# Thème sombre
# ======================================================
FOND = "#121212"         # fond général
BLEU = "#1E88E5"         # couleur secondaire (sélection)
ROUGE = "#EF5350"        # erreurs
GRIS = "#333333"         # bouton inactif
ENTREE_BG = "#1E1E1E"    # arrière-plan des Entry
TEXTE = "#E0E0E0"         # texte clair
BOUTON_BG = "#1E1E1E"     # bouton sombre
...
def save_config(path):
    os.makedirs(LAUNCHER_DIR, exist_ok=True)  # s'assure que le dossier Luncher existe
...
manga_listbox = tk.Listbox(frame_listes, width=25, height=20, bg=ENTREE_BG, fg=TEXTE, selectbackground=BLEU, selectforeground=TEXTE)
manga_listbox.grid(row=1, column=0, padx=5, pady=5)
manga_listbox.bind("<<ListboxSelect>>", show_chapters)

chapter_listbox = tk.Listbox(frame_listes, width=25, height=20, bg=ENTREE_BG, fg=TEXTE, selectbackground=BLEU, selectforeground=TEXTE)
