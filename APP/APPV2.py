...
tk.Button(finder, text="Ajouter chapitres", command=ajouter_chapitres_depuis_entry, bg=BOUTON_BG).pack(pady=5)
liste = tk.Listbox(finder, width=30, height=8)
liste.pack(pady=5)
tk.Button(finder, text="Trouver le nombre de pages", command=trouver_pages_tous, bg=BOUTON_BG).pack(pady=10)
...
tk.Button(downloader, text="Choisir dossier", command=choisir_dossier, bg=BOUTON_BG).pack()
...
tk.Button(downloader, text="Télécharger", command=telecharger, bg=BOUTON_BG, font=("Arial",12,"bold")).pack(pady=10)
