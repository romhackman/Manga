...
def lancer_share():
    lancer_script(os.path.join(BASE_DIR, "share.py"))


def lancer_APP():
    lancer_script(os.path.join(BASE_DIR, "error", "APP.py"))
...
tk.Button(frame_boutons, text="Share", command=lancer_share).pack(side="left", padx=2)
tk.Button(frame_boutons, text="APP", command=lancer_APP).pack(side="left", padx=2)
